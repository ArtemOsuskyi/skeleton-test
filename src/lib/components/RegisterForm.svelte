<script lang="ts">
  import { getToastStore, ProgressRadial, Toast, type ToastSettings } from '@skeletonlabs/skeleton';
...
>
  ...
  {:else}
    <button id="button" type="submit" class="btn variant-filled-primary max-w-fit self-center">
      Register
    </button>
  {/if}
</form>
